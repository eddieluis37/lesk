        ...
        <div class='col-md-12'>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ trans('ticket::general.page.sign-out.box-title') }}</h3>
                ...
                <div class="box-body">
                    ...
                    {!! Form::model($item, ['route' => 'ticket.post-sign-out', 'method' => 'POST']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            {!! Form::submit(trans('ticket::general.button.sign-out'), ['class' => 'btn btn-primary']) !!}
                            <a href="{!! route('ticket.index') !!}" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group date">
                                                ...
                                                <input name="from_date" type="text" class="form-control pull-right" id="datepickerFrom" placeholder="{{trans('ticket::general.page.sign-out.from_date')}}" readonly="readonly">
                                            </div><!-- /.input group -->
                                        </td>
                                        <td>
                                            <div class="input-group date">
                                                ...
                                                <input name="to_date" type="text" class="form-control pull-right" id="datepickerTo" placeholder="{{trans('ticket::general.page.sign-out.to_date')}}" readonly="readonly">
                                            </div><!-- /.input group -->
                                        </td>
                                        <td></td>
                                    </tr>
